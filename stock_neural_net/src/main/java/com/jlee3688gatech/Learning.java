...
public class Learning {
    ...
    public int makeExamples(int targetTickerNum, int targetNumOfInc, String targetDataType, int targetDataCountFrom,
     int targetDataCountTo, ArrayList<String> inputDataTypes, int numOfDataFromCounter) {

        int numOfExample = 0;

        ArrayList<ArrayList<Double>> temp = exampleMaker.getExamples(targetTickerNum, targetNumOfInc, targetDataType, targetDataCountFrom, targetDataCountTo
        ...
        while(temp != null) {
            ...
            temp = exampleMaker.getExamples(targetTickerNum, targetNumOfInc, targetDataType, targetDataCountFrom, targetDataCountTo
            , inputDataTypes, numOfDataFromCounter);
        }
    ...
    public int makeExamples(int targetTickerNum) {
        ...
        return makeExamples(targetTickerNum, 3, "adjclosed", 5, 10, inputTypes, 5);
    }
    ...
    public void backPropLearnNeuralNet(double learningRate, int maxIteration, double minError) {
        if (checkAvailable()) {
            ...
            while(error > minError && iteration < maxIteration) {
                ...
                String str = "iteration == " + iteration + "  " + "total iteration == " + (iteration * examples.size()) + "  " + "error == " + error;
