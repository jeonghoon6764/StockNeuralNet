...
public class Learn1ServerVersionController {
    ...
    public void userClickaddStocksButton(ActionEvent actionEvent) throws IOException {
        ...
        controller.setLearn1ServerVersionController(this);
    ...
    public void userClickNext(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FXML" + slash + "NetworkServerLearn2.fxml"));
        Parent root = loader.load();
        Learn2ServerVersionController controller = loader.<Learn2ServerVersionController>getController();
